...
<!-- 		<link rel="shortcut icon" href="../favicon.ico"> -->
		<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resources/main/css/normalize.css" />
		<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resources/main/css/register-demo.css" />
		<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resources/main/css/register-component.css" />
		<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resources/main/css/cs-select.css" />
	...
	<body>
		...
		<script src="${pageContext.request.contextPath}/resources/main/js/classie.js"></script>
		<script src="${pageContext.request.contextPath}/resources/main/js/selectFx.js"></script>
		<script src="${pageContext.request.contextPath}/resources/main/js/fullscreenForm.js"></script>
		<script>
			(function() {
